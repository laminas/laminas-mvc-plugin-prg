...
[create a proposal](https://github.com/zendframework/zend-mvc-plugin-prg/issues/new).
...
2. Fork the repository (https://github.com/zendframework/zend-mvc-plugin-prg)
